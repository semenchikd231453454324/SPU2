...
COM_SRC= $(addprefix $(com_src_prefix), SPUStructFuncs.cpp ReadWritebin.cpp)
COM_OBJ= $(addprefix $(com_build_dir), SPUStructFuncs.o ReadWritebin.o)

ASM_SRC= $(addprefix $(asm_src_prefix), main.cpp Assembler.cpp AsmStructFuncs.cpp TextProcessing.cpp LabelsSearch.cpp) $(COM_SRC)
ASM_OBJ= $(addprefix $(asm_build_dir), main.o Assembler.o AsmStructFuncs.o TextProcessing.o LabelsSearch.o) $(COM_OBJ)

PRC_SRC= $(addprefix $(prc_src_prefix_src_prefix), main.cpp Run.cpp GetArgs.cpp) $(COM_SRC)
PRC_OBJ= $(addprefix $(prc_build_dir),  main.o Run.o GetArgs.o) $(COM_OBJ)
...
$(ASM_EXE_NAME): $(ASM_OBJ) $(COM_OBJ)
	@echo "[LD] Linking"
	@g++ $(ASM_OBJ) ${DED_FLAGS} ${LIB} -o $(ASM_EXE_NAME) 
...
processor: prepare $(PROC_EXE_NAME)

$(PROC_EXE_NAME): $(PRC_OBJ) $(COM_OBJ)
	@echo "[LD] Linking"
	@g++ $(PRC_OBJ) ${DED_FLAGS} ${LIB} -o $(PROC_EXE_NAME) 

$(prc_build_dir)%.o: $(prc_src_prefix)%.cpp
	@echo "[CXX] $@"
	@g++ -c $^ ${DED_FLAGS} -o $@
